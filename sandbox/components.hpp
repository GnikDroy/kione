...
namespace k2 {
    ...
    template<>
    void ComponentEditorWidget<PointLight>(entt::registry &reg, entt::registry::entity_type e) {
    ...
    template<>
    void ComponentEditorWidget<DirectionalLight>(entt::registry &reg, entt::registry::entity_type e) {
