...
namespace k2 {
    ...
    public:
        ...
        ComponentInfo &register_component(const ComponentInfo &component_info) {
        ...
        template<class Component>
        ComponentInfo &register_component(const std::string &name) {
        ...
        [[deprecated("Use render_editor() instead. And manage the window yourself.")]]
