...
inline ImVec4 ImVec4Color(const std::string& hex_code) {
...
struct ImGuiThemeDark : ImGuiTheme {
    ...
    ImGuiThemeDark() {
        ...
        colors["primary"_fnv1a] = ImVec4Color("#3F51B5ff");
        colors["primary_alt"_fnv1a] = ImVec4Color("#303F9Fff");
        colors["secondary"_fnv1a] = ImVec4Color("#792021ff");
        colors["secondary_alt"_fnv1a] = ImVec4Color("#7d1021ff");
        colors["background"_fnv1a] = ImVec4Color("#181818ff");
        colors["background_alt"_fnv1a] = ImVec4Color("#141414ff");

        colors["log_trace"_fnv1a] = ImVec4Color("#a0a0a0ff");
        colors["log_debug"_fnv1a] = ImVec4Color("#e5e5e5ff");
        colors["log_info"_fnv1a] = ImVec4Color("#ffffffff");
        colors["log_warn"_fnv1a] = ImVec4Color("#ffff00ff");
        colors["log_err"_fnv1a] = ImVec4Color("#aa0000ff");
        colors["log_critical"_fnv1a] = ImVec4Color("#ff0000ff");
    ...
    void apply() const override {
        ...
        im_colors[ImGuiCol_Text] = ImVec4Color("#e5e5e5ff");
        im_colors[ImGuiCol_TextDisabled] = ImVec4Color("#7f7f7fff");
        ...
        im_colors[ImGuiCol_Border] = ImVec4Color("#262626FF");
        im_colors[ImGuiCol_BorderShadow] = ImVec4Color("#ffffff00");
        ...
        im_colors[ImGuiCol_ScrollbarGrab] = ImVec4Color("#4f4f4f4c");
        im_colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4Color("#ffffff4c");
        im_colors[ImGuiCol_ScrollbarGrabActive] = ImVec4Color("#ffffff7f");
        im_colors[ImGuiCol_CheckMark] = ImVec4Color("#e5e5e5ff");
        im_colors[ImGuiCol_SliderGrab] = ImVec4Color("#4f4f4fff");
        im_colors[ImGuiCol_SliderGrabActive] = ImVec4Color("#ffffff7f");
        im_colors[ImGuiCol_Button] = ImVec4Color("#232323ff");
        im_colors[ImGuiCol_ButtonHovered] = colors.at("primary"_fnv1a);
        im_colors[ImGuiCol_ButtonActive] = colors.at("primary_alt"_fnv1a);
        im_colors[ImGuiCol_Header] = ImVec4Color("#232323ff");
        im_colors[ImGuiCol_HeaderHovered] = colors.at("primary"_fnv1a);
        im_colors[ImGuiCol_HeaderActive] = colors.at("primary_alt"_fnv1a);
        im_colors[ImGuiCol_Separator] = ImVec4Color("#7f7f6d7f");
        ...
        im_colors[ImGuiCol_Tab] = ImVec4Color("#262F5DFF");
        ...
        im_colors[ImGuiCol_PlotLines] = ImVec4Color("#636363ff");
        im_colors[ImGuiCol_PlotLinesHovered] = ImVec4Color("#59eaffff");
        ...
        im_colors[ImGuiCol_NavWindowingDimBg] = ImVec4Color("#33333333");
        im_colors[ImGuiCol_ModalWindowDimBg] = ImVec4Color("#33333359");
